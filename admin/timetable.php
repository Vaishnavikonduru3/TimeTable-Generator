...
$que=mysqli_query($con,"select *  from timeschedule");
	...
	echo "<td><a href='admindashboard.php?info=deletetimetable&timeschedule_id=$res[timeschedule_id]'>Delete</a></td>";
	}
	?>
    
	
	<a href='javascript:deleteData("<?php echo  $res[timeschedule_id];?>")'>Delete</a>
	<?php
	echo "</tr>";
