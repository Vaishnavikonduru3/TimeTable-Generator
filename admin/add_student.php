...
$row=mysqli_num_rows($que);
	...
	$image=$_FILES['pic']['name'];	
       ...
       mysqli_query($con,"insert into student               values('','$stname','$eid','$p','$mobile','$address','$courseid','$s','$dob','$gen',now())");	
...
<table border="0" class="table">
  ...
  <tr>
   ...
   <tr>
    ...
    <td>male<input type="radio"value="male" id="gen" name="gen"/>
		female<input type="radio"value="female" id="gen" name="gen"/></td>
  </tr>
