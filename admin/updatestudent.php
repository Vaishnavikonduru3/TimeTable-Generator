...
unlink("../student/image/$email/$oldimg");
	...
	mysqli_query($con,"update student set name='$name',eid='$eid',password='$p',mob='$mobile,address='$address',department_id='$course',sem_id='$semester',dob='$dob',gender='$gen' where  stu_id='".$_SESSION['stu_id']."'");
