...
if(isset($save))
{
    ...
    //$r=mysqli_num_rows("mysqli_query($con,"select * from teacher where eid='".$e."' and password='".$p."'"");
   // $res=mysqli_fetch_array("mysqli_query($con,"select * from teacher where eid='".$e."' and password='".$p."'"");
...
<div class="col-md-5" align="center">
       ...
       <h6 style="padding-top:20px"><a href="../index.php"><font color="#0066CC" size="+2">HOME</font></a></h6> 
